...
export default function App() {
  ...
  const t = {
    es: {
      ...
      form: {
        ...
        especificoBullet2: '✓ Logros relevantes destacados',
        especificoBullet3: '✓ Formato ATS para esa industria',
      ...
      features: {
        ...
        ai: 'Análisis IA',
        aiDesc: 'Revisión automática con inteligencia artificial',
        fast: 'Entrega Rápida',
        fastDesc: 'Revisión genérica inmediata, otros en 24hrs'
      },
      footer: {
    ...
    en: {
      ...
      form: {
        ...
        especificoBullet2: '✓ Relevant achievements highlighted',
        especificoBullet3: '✓ ATS format for that industry',
      ...
      features: {
        ...
        ai: 'AI Analysis',
        aiDesc: 'Automatic review with artificial intelligence',
        fast: 'Fast Delivery',
        fastDesc: 'Generic review immediate, others in 24hrs'
      },
      footer: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formDataToSend.append('formLanguage', language);
      ...
      <section className="max-w-5xl mx-auto px-6 py-16">
          ...
          <form onSubmit={handleSubmit} className="p-8 space-y-8">
            <section>
              <h4 className="text-lg font-semibold text-slate-900 mb-4 pb-2 border-b border-slate-200">
                {t[language].form.section1}
              </h4>
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-2">
                    {t[language].form.nombre} *
                  </label>
                  <input
                    type="text"
                    required
            ...
            {formData.tieneCV === 'si' && (
              <section>
                <h4 className="text-lg font-semibold text-slate-900 mb-4 pb-2 border-b border-slate-200">
                  {t[language].form.section3Upload}
                </h4>
                <div className="border-2 border-dashed border-slate-300 rounded-lg p-8 text-center hover:border-blue-500 transition-colors">
                  <Upload className="w-12 h-12 text-slate-400 mx-auto mb-3" />
                  <label className="cursor-pointer">
                    <span className="text-blue-600 font-medium hover:text-blue-700">
                      {t[language].form.selectCV}
                    </span>
                    <input
                      type="file"
                      accept=".pdf"
                  ...
                  <div className="border-2 border-dashed border-purple-400 rounded-lg p-6 text-center hover:border-purple-600 transition-colors bg-white">
                    ...
                    <label className="cursor-pointer">
                      <span className="text-purple-600 font-medium hover:text-purple-700 text-lg">
                        {t[language].form.selectLinkedIn}
                      </span>
                      <input
                        type="file"
                        accept=".pdf"
                  ...
                  <label className="flex items-start p-5 border-2 border-blue-300 bg-blue-50 rounded-lg cursor-pointer hover:bg-blue-100 transition-colors">
                    ...
                    <div className="ml-3">
                      ...
                      <p className="text-sm text-slate-700 mb-2">
                        {t[language].form.especificoDesc}
                      </p>
              ...
              <section>
                ...
                <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-4 mb-4">
                  <p className="text-sm font-semibold text-blue-900 mb-1">
                    {t[language].form.puestoNote}
                  </p>
                  <p className="text-xs text-blue-700">
                    {t[language].form.puestoNoteDesc}
                  </p>
                </div>
              ...
              <section>
                <h4 className="text-lg font-semibold text-slate-900 mb-4 pb-2 border-b border-slate-200">
                  {formData.tieneCV === 'si' && formData.tipoRevision === 'premium' && formData.tipoCV === 'especifico' ? '8' :
                   ...
                   formData.tipoCV === 'especifico' ? '6' : '5'}. {t[language].form.infoSection}
                </h4>
                ...
                <div className="flex justify-between items-center mt-2">
                  <p className="text-sm text-slate-600">
                    {t[language].form.palabras} {wordCount}/500
                  </p>
                  {wordCount > 450 && (
                    <p className="text-sm text-amber-600 font-medium">
                      {500 - wordCount} {t[language].form.palabrasRestantes}
                    </p>
                  )}
                </div>
              </section>
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-16">
          ...
          <div className="text-center">
            ...
            <h3 className="font-semibold text-slate-900 mb-2">{t[language].features.ai}</h3>
            <p className="text-sm text-slate-600">{t[language].features.aiDesc}</p>
          </div>
          <div className="text-center">
            ...
            <h3 className="font-semibold text-slate-900 mb-2">{t[language].features.fast}</h3>
            <p className="text-sm text-slate-600">{t[language].features.fastDesc}</p>
          </div>
        </div>
      </section>
      ...
      <footer className="border-t border-slate-200 bg-white mt-16">
        <div className="max-w-5xl mx-auto px-6 py-8">
          <div className="text-center text-sm text-slate-600">
            ...
            <p className="mt-2">
              {t[language].footer.contact} <a href="mailto:jrgarcia@nocodia.net" className="text-blue-600 hover:text-blue-700 font-medium">jrgarcia@nocodia.net</a>
            </p>
          </div>
        </div>
      </footer>
